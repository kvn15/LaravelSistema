...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active"><a href="{{ route('admin.personal.create') }}">Nuevo Usuario</a></div>
    </div>
</div>
...
<div class="section-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {!! Form::open(['route' => 'config.user.store','method' => 'post', 'autocomplete' => 'off']) !!}
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                {!! Form::password('password', ['class' => 'form-control', 'placeholder' => 'Ejem. asd214sd4A']) !!}
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label>Contraseña <span class="text-danger">*</span></label>
