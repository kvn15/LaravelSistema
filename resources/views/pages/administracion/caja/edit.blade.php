...
@section('content')
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.caja.edit', $caja) }}">Editar Caja</a></div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::model($caja,['route' => ['admin.caja.update',$caja],'method' => 'put','autocomplete' => 'off']) !!}
                            <div class="row">
