...
@section('content')
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.presentacion.edit', $presentacion) }}">Editar Presentacion</a></div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::model($presentacion,['route' => ['admin.presentacion.update',$presentacion],'method' => 'put','autocomplete' => 'off']) !!}
                            <div class="row">
