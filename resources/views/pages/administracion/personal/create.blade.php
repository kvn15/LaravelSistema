...
@section('content')
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.personal.create') }}">Nuevo Personal</a></div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.personal.store') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
