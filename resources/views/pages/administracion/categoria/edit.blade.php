...
@section('content')
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('admin.categoria.edit', $categorium) }}">Editar Categoria</a></div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::model($categorium,['route' => ['admin.categoria.update',$categorium],'method' => 'put','autocomplete' => 'off']) !!}
                            <div class="row">
